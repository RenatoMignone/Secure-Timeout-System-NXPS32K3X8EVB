...
#define CONFIG_QEMU_INTERP_PREFIX "/usr/gnemul/qemu-aarch64"
...
#define TARGET_SYSTBL syscall_64.tbl

#define TARGET_SYSTBL_ABI common,64,renameat,rlimit,memfd_secret
