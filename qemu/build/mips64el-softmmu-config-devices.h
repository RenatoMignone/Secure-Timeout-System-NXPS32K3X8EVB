...
#define CONFIG_FDC37M81X 1

#define CONFIG_FDC_ISA 1

#define CONFIG_FDC_SYSBUS 1
...
#define CONFIG_LOONGSON3V 1

#define CONFIG_LOONGSON_IPI 1

#define CONFIG_LOONGSON_IPI_COMMON 1
